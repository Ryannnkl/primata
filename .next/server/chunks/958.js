...
/* harmony export */ });
/* unused harmony exports css, globalCss, keyframes, theme, createTheme, config */
...
const { styled , css , globalCss , keyframes , getCssText , theme , createTheme , config ,  } = (0,_stitches_react__WEBPACK_IMPORTED_MODULE_0__.createStitches)({
    theme: {
        colors: {
            yellow: '#ffff80',
            pink: '#ff80bf',
